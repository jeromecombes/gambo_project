...
class FormTest extends MyTestCase
{
    public function test_form_status_200()
    {
        ...
        $response->assertStatus(200)
            ...
            ->assertSee('<button class="btn btn-secondary" type="button" onclick="location.href=', false)
            ->assertSee('">Cancel</button>', false)
            ->assertSee('<button class="btn" type="button" onclick="someJSAFunction();">Delete</button>', false)
