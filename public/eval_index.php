...
$tutorats=$db->result;
$db=new db();
$db->select("evaluations","*","student='$std_id' AND form='linguistique' AND semester='$semester'","GROUP BY timestamp");
$linguistique=$db->result;
$db=new db();
$db->select("evaluations","*","student='$std_id' AND form='method' AND semester='$semester'","GROUP BY timestamp");
$method=$db->result;
