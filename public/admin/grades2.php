...
// print_r($students);
  ...
  case "univ" :
    $u=new univ();
    $u->fetchByCode($univ2,$code);
    $course=array("code"=>$u->element['cm_code_en'],"title"=>$u->element['cm_name_en'],"professor"=>$u->element['cm_prof']);
//     $students[]=array("id"=>$u->element['student'],"lastname"=>$u->element['studentLastname'],"firstname"=>$u->element['studentFirstname']);
    $students=$u->students;
    break;
...
if(in_array(19, $_SESSION['vwpp']['access']) or in_array(20, $_SESSION['vwpp']['access'])){
  echo "<td>Grade US</td><td>Date Recorded</td>";
}
...
if(in_array(18,$_SESSION['vwpp']['access']) or in_array(19,$_SESSION['vwpp']['access'])){
  ...
  <input type='button' onclick='location.href="grades2.php"'; value='Cancel'/>
