...
<a href='/admin/housing'>Housing Home</a> > <a href='/hosts'>Liste des logements</a>
<br/><br/>
...
<input type='button' value='Retour' onclick='document.location.href="/hosts";' id='form_1_<?php echo $i++; ?>' class='myUI-button-right' />
