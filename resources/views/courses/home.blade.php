...
@section('content')
  ...
  <table class='datatable' data-sort='[[2,"asc"],[3,"asc"]]' >
    ...
    @foreach ($courses->local as $course)
      <tr>
        <td>
          <a href="/admin/courses-edit.php?id={{ $course->id }}">
  ...
  <div style='margin:30px 0; text-align:right;'>
    ...
    @if (in_array(16, Auth::user()->access))
      <input type='button' onclick='location.href="/admin/courses-edit.php?univ=rh";' value='Add a VWPP Course' class='btn btn-primary' />
    @endif
  </div>
