<nav>
  <ul class='ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all' id='student-menu' >
    ...
    @if(!empty(array_intersect(array(2,7), session('access'))))
    ...
    @if(!empty(array_intersect(array(16,21,23), session('access'))))
    ...
    @if(!empty(array_intersect(array(3,8), session('access'))))
