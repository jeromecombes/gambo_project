...
@if (session('admin'))
  <a href='/admin/eval_index.php' style='margin-left:30px;'>All evaluations</a> ><a href='/admin/eval_all.php'>Program Evaluations</a>
@endif
...
<div style='text-align:right; margin:30px 0 50px;'>
  ...
  <h3 style='text-align:center;'>VASSAR-WESLEYAN PROGRAM IN PARIS<br/>Program Evaluation Form, {{ session('semester') }}</h3>
</div>


<fieldset class='evaluations'>
  <form method='post' action='{{ route("evaluations.update") }}' name='form' onsubmit='return ctrl_form3();' >
    <input type='hidden' name='form' value='program' />
