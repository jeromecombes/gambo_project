      ...
      <tr>
        ...
        <td>
          @if ($edit)
            <input type='text' name='answer[1]' value='{{ $answer[1] }}' />
          @else
      ...
      <tr>
        ...
        <td>
          @if ($edit)
            <input type='text' name='answer[4]' value='{{ $answer[4] }}' />
          @else
      ...
      <tr>
        ...
        <td>
          @if ($edit)
            <select name='answer[5]'>
              <option value=''>&nbsp;</option>
              @foreach ($states as $state)
                <option value='$elem' @if ($answer[5] == $state) selected='selected' @endif >{{ $state }}</option>
              @endforeach
            </select>
          @else
      ...
      <tr>
        <td colspan='6'>
          @if ($edit)
            <textarea name='answer[8]'>{{ $answer[8] }}</textarea>
          @else
            <font class='response' colspan='2'>{{ $answer[8] }}</font>
          @endif
        </td>
      </tr>
      ...
      <tr>
        ...
        <td colspan='2'>
          @if ($edit)
            <input type='text' name='answer[10]' value='{{ $answer[10] }}' />
          @else
      ...
      <tr>
        ...
        <td colspan='2'>
          @if ($edit)
            <input type='text' name='answer[11]' value='{{ $answer[11] }}' />
          @else
      ...
      <tr>
        ...
        <td colspan='2'>
          @if ($edit)
            <input type='text' name='answer[12]' value='{{ $answer[12] }}' />
          @else
      ...
      <tr>
        ...
        <td colspan='2'>
          @if ($edit)
            <input type='text' name='answer[13]' value='{{ $answer[13] }}' />
          @else
      ...
      <tr>
        <td colspan='6'>
          @if ($edit)
            <textarea name='answer[19]'>{{ $answer[19] }}</textarea>
          @else
            <font class='response'>{{ $answer[19] }}</font>
          @endif
        </td>
      </tr>
      ...
      @if (!empty($dates))
        ...
        <tr>
          <td colspan='6'>
            @if ($edit)
              <font class='response'>{{ $answer[22] }}</font>
            @else
              <textarea name='answer[22]'>{{ $answer[22] }}</textarea>
            @endif
          </td>
        </tr>
      @endif
      ...
      <tr>
        ...
        <td>
          @if ($edit and session('admin'))
            <input type='text' name='answer[20]' value='{{ $answer[20] }}' />
          @else
            <input type='hidden' name='answer[20]' value='{{ $answer[20] }}' />
      ...
      <tr>
        ...
        <td>
          @if ($edit and session('admin'))
            <input type='text' name='answer[21]' value='{{ $answer[21] }}' />
          @else
            <input type='hidden' name='answer[21]' value='{{ $answer[21] }}' />
