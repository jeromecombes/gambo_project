      ...
      <tr>
        ...
        <td colspan='2'>
          @if ($edit)
            <input type='text' name='answer[2]' value='{{ $answer[2] }}' />
          @else
      ...
      <tr>
        ...
        <td colspan='2'>
          @if ($edit)
            <input type='text' name='answer[3]' value='{{ $answer[3] }}' />
          @else
      ...
      <tr>
        <td colspan='6'>
          @if ($edit)
            <textarea name='answer[9]'>{{ $answer[9] }}</textarea>
          @else
      ...
      @if (!empty($dates))
        ...
        <tr>
          <td colspan='6'>
            ...
            @else
              <textarea name='answer[11]'>{{ $answer[11] }}</textarea>
            @endif
          </td>
        </tr>
      @endif
